...
export default function Footer({ siteName, footerText, email }: FooterProps) {
  ...
  return (
    <footer className="bg-[var(--color-navy)] text-[var(--color-cream)] py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[var(--color-cream)]/70 max-w-md mb-6 leading-relaxed">
              The Jewish Heritage Education and Advocacy Center carries the
              message of the Jewish Museum of Chile across North America,
              bringing memory to life through education.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="text-[var(--color-cream)]/70 flex items-start gap-2">
                <svg
